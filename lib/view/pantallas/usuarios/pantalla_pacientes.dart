...
class _PantallaPacientesState extends State<PantallaPacientes> {
  void _mostrarFormulario({DocumentSnapshot? pacienteExistente}) {
    ...
    final TextEditingController _edadController = TextEditingController(
        text: pacienteExistente != null ? pacienteExistente['edad'].toString() : '');
    final TextEditingController _pesoController = TextEditingController(
        text: pacienteExistente != null ? pacienteExistente['peso'].toString() : '');
    final TextEditingController _alturaController = TextEditingController(
        text: pacienteExistente != null ? pacienteExistente['altura'].toString() : '');
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: Text(pacienteExistente == null ? 'Agregar Paciente' : 'Editar Paciente'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final altura = double.tryParse(_alturaController.text.trim()) ?? 0.0;
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () => _mostrarFormulario(pacienteExistente: paciente),
                    ),
                    IconButton(
